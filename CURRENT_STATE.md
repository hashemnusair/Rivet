...
- A real signed-in Clerk role/session matrix remains unverified; the available browser was signed out. CI for the main routing commit is [run 34619692700](https://github.com/hashemnusair/Rivet/actions/runs/34619692700), still running when these checks were recorded, with the credential-gated generated-code job passed. No customer, financial or tenant data was changed.
