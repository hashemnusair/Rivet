...
- Release status: code is ready for the existing `rivet-web` production deployment. Live deployment and domain evidence will be appended after release. A real Clerk role/session matrix is still unverified; the available browser was signed out. No customer, financial or tenant data was changed.
