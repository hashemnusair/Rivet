...
const PAGE_LABELS: Array<{ prefix: string; id: string; title: string }> = [
  ...
  { prefix: "/checkout", id: "checkout", title: "Checkout" },
  { prefix: "/operations/payables", id: "payables", title: "Payables" },
  { prefix: "/operations", id: "operations", title: "Stock & purchasing" },
  { prefix: "/maintenance", id: "maintenance", title: "Maintenance" },
