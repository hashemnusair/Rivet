...
function AtRiskQueuePage() {
  ...
  return <div className="grid gap-4 lg:grid-cols-[220px_minmax(0,1fr)]">
    ...
    <div className={cn("grid gap-4", selectedItem && "22xl:grid-cols-[minmax(0,1fr)_340px]")}>
