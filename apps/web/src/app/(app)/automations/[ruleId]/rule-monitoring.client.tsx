...
export default function RuleMonitoringClient() {
  ...
  return <div className="space-y-5">
    ...
    <PageHeader eyebrow="System · Read-only rule" title={value.name} description="Inspect the saved trigger, actions, deduplication policy, and immutable execution history." actions={<Badge variant={value.enabled ? "warning" : "neutral"} dot>{value.enabled ? "enabled · held" : "paused"}</Badge>} />
