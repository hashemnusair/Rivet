...
export function OperationalEmailSection() {
  ...
  return <div className="pb-4"><section className="panel overflow-hidden">
    ...
    <div className="flex flex-wrap items-center gap-2 border-b border-line bg-sunken/40 px-5 py-2.5 text-[12px] text-ink-2" data-testid="email-delivery-mode">
      ...
      {settings.deliveryModeSource === "legacy_live_flag" ? <span className="text-warning-deep">Set by the deprecated RIVET_OPERATIONAL_EMAIL_LIVE flag; configure RIVET_EMAIL_MODE instead.</span> : null}
      {settings.deliveryModeWarning ? <span className="text-warning-deep">{settings.deliveryModeWarning}</span> : null}
    </div>
