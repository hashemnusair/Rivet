...
export const seedDemoTenant = internalMutation({
  ...
  handler: async (ctx) => {
    ...
    await upsertDomain("customerProfile", "customer-lina", { userId: seedPublicId("lina@example.com"), name: "Lina Haddad", nameAr: "لينا حداد", email: "lina@example.com", phone: "+962 79 440 2211", initials: "LH", context: "Active at Forge Fitness" });
    await upsertDomain("customerProfile", "customer-yousef", { userId: seedPublicId("yousef@example.com"), name: "Yousef Nasser", nameAr: "يوسف ناصر", email: "yousef@example.com", phone: "+962 78 441 9033", initials: "YN", context: "Looking for a gym" });
