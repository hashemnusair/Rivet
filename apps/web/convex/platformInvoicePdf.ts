  ...
  const blocks: PdfBlock[] = [
      ...
      columns: [
        {
          heading: "From",
          lines: [
            { text: "RIVET", font: "bold" },
            { text: BRAND_CONTACT.city },
            { text: BRAND_PLACEHOLDERS.legalEntityWithTax, color: "#B6B3A6", size: 9 },
            { text: BRAND_CONTACT.website, size: 9 },
            { text: BRAND_CONTACT.billingEmail, size: 9 },
          ],
        },
        {
          heading: "Bill to",
    ...
    },
    {
      ...
      rows: [
        ...
        { label: "Tax", value: "[Treatment to be decided]", muted: true },
          ...
          columns: [
            {
              ...
              lines: [
                { text: "Bank [Bank name]", color: "#B6B3A6", size: 9 },
                { text: "Account name [Legal entity name]", color: "#B6B3A6", size: 9 },
                { text: "IBAN [JO00 0000 0000 0000 0000 0000 0000]", color: "#B6B3A6", size: 9 },
                { text: "SWIFT [XXXXJOXX]", color: "#B6B3A6", size: 9 },
              ],
            },
            {
              heading: "CliQ",
              lines: [
                { text: "Alias [RIVETJO]", color: "#B6B3A6", size: 9 },
                { text: "Name [Legal entity name]", color: "#B6B3A6", size: 9 },
              ],
            },
          ],
        },
...
export function renderInvoicePdf(input: InvoicePdfInput): Uint8Array {
  return renderPdf(invoicePdfBlocks(input), {
    ...
    footer: `${input.number} · RIVET, ${BRAND_CONTACT.city} · ${BRAND_CONTACT.billingEmail}`,
    footerPlaceholder: BRAND_PLACEHOLDERS.legalEntityWithTax,
