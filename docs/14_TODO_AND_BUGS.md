...
| Dashboard scope copy and consent defaults | 2026-08-09 | `2269863` | 246 unit tests, 19 preview Playwright journeys, typecheck, Convex typecheck, lint, and production build pass. Production one-branch visual verification and consent provenance/revocation remain open. |
